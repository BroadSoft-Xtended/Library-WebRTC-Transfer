...
styles/css: $(STYLUS_FILES)
	stylus --include-css styles/transfer.styl -o styles

styles/min.css: styles/css
	cssmin styles/*.css > styles/transfer.min.css

node_modules/bdsft-webrtc-styles.js: styles/min.css
	node_modules/webrtc-core/scripts/export-style styles/transfer.min.css node_modules/bdsft-webrtc-styles.js
